...
namespace Ryujinx.UI.Common.Configuration
{
    public class ConfigurationState
    {
        ...
        /// <summary>
        /// Allows the initial Missing prod.keys warning to be skipped
        /// </summary>
        public ReactiveObject<bool> IgnoreKeysWarning { get; private set; }
        ...
        private ConfigurationState()
        {
            ...
            IgnoreKeysWarning = new ReactiveObject<bool>();
        ...
        public ConfigurationFileFormat ToFileFormat()
        {
            ConfigurationFileFormat configurationFile = new()
            {
                ...
                IgnoreKeysWarning = IgnoreKeysWarning,
        ...
        public void Load(ConfigurationFileFormat configurationFileFormat, string configurationFilePath)
        {
            ...
            if (configurationFileFormat.Version < 50)
            {
                ...
                configurationFileFormat.IgnoreKeysWarning = false;
            ...
            IgnoreKeysWarning.Value = configurationFileFormat.IgnoreKeysWarning;
